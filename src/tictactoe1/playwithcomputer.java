 ...
 */
public class playwithcomputer extends javax.swing.JFrame {
...
//       }
   ...
   {
//  Timer tt = new Timer(10000, (ActionListener) this);
//        
//       try {
//           tt.wait(2000);
//       } catch (InterruptedException ex) {
...
new java.util.Timer().schedule( 
        ...
        if(" o".equals(x1.getText())&&" o".equals(x2.getText()) && "  ".equals(x3.getText()) ) 
           x3.setText(" o");
       
       else if(" o".equals(x2.getText())&&" o".equals(x3.getText())&& "  ".equals(x1.getText())  ) 
           x1.setText(" o");
       else if(" o".equals(x1.getText())&&" o".equals(x3.getText()) && "  ".equals(x2.getText())  ) 
           x2.setText(" o");
       
       
       
       else if(" o".equals(x4.getText())&&" o".equals(x5.getText()) && "  ".equals(x6.getText()) ) 
           x6.setText(" o");
       else if(" o".equals(x5.getText())&&" o".equals(x6.getText()) && "  ".equals(x4.getText()) ) 
           x4.setText(" o");
       else if(" o".equals(x4.getText())&&" o".equals(x6.getText()) && "  ".equals(x5.getText()) ) 
           x5.setText(" o");
       
       
       
       else if(" o".equals(x7.getText())&&" o".equals(x8.getText()) && "  ".equals(x9.getText()) ) 
           x9.setText(" o");
       else if(" o".equals(x8.getText())&&" o".equals(x9.getText()) && "  ".equals(x7.getText()) ) 
           x7.setText(" o");
       else if(" o".equals(x7.getText())&&" o".equals(x9.getText()) && "  ".equals(x8.getText()) ) 
           x8.setText(" o");
       
       
       
       else if(" o".equals(x1.getText())&&" o".equals(x4.getText()) && "  ".equals(x7.getText()) ) 
           x7.setText(" o");
       else if(" o".equals(x4.getText())&&" o".equals(x7.getText())  && "  ".equals(x1.getText())) 
           x1.setText(" o");
       else if(" o".equals(x1.getText())&&" o".equals(x7.getText()) && "  ".equals(x4.getText()) ) 
           x4.setText(" o");
       
       
       
       else if(" o".equals(x2.getText())&&" o".equals(x5.getText())  && "  ".equals(x8.getText())) 
           x8.setText(" o");
       else if(" o".equals(x8.getText())&&" o".equals(x5.getText())  && "  ".equals(x2.getText())) 
           x2.setText(" o");
       else if(" o".equals(x2.getText())&&" o".equals(x8.getText())  && "  ".equals(x5.getText())) 
           x5.setText(" o");
       
       
       
       
      else if(" o".equals(x3.getText())&&" o".equals(x6.getText())  && "  ".equals(x9.getText())) 
           x9.setText(" o");
       else if(" o".equals(x6.getText())&&" o".equals(x9.getText()) && "  ".equals(x3.getText()) ) 
           x3.setText(" o");
       else if(" o".equals(x3.getText())&&" o".equals(x9.getText()) && "  ".equals(x6.getText()) ) 
           x6.setText(" o");
       
       
       
       else if(" o".equals(x1.getText())&&" o".equals(x5.getText()) && "  ".equals(x9.getText()) ) 
           x9.setText(" o");
       else if(" o".equals(x5.getText())&&" o".equals(x9.getText()) && "  ".equals(x1.getText()) ) 
           x1.setText(" o");
       else if(" o".equals(x1.getText())&&" o".equals(x9.getText())  && "  ".equals(x5.getText())) 
           x5.setText(" o");
       
       
       
       else if(" o".equals(x3.getText())&&" o".equals(x5.getText()) && "  ".equals(x7.getText()) ) 
           x7.setText(" o");
       else if(" o".equals(x7.getText())&&" o".equals(x5.getText())&& "  ".equals(x3.getText())  ) 
           x3.setText(" o");
       else if(" o".equals(x3.getText())&&" o".equals(x7.getText()) && "  ".equals(x5.getText()) ) 
           x5.setText(" o");
...
// coomputer close
       ...
       else if(" x".equals(x1.getText())&&" x".equals(x2.getText()) && "  ".equals(x3.getText())  ) 
           x3.setText(" o");
       
       else if(" x".equals(x2.getText())&&" x".equals(x3.getText()) && "  ".equals(x1.getText()) ) 
           x1.setText(" o");
       else if(" x".equals(x1.getText())&&" x".equals(x3.getText()) && "  ".equals(x2.getText()) ) 
           x2.setText(" o");
       
       
       
       else if(" x".equals(x4.getText())&&" x".equals(x5.getText()) && "  ".equals(x6.getText()) ) 
           x6.setText(" o");
       else if(" x".equals(x5.getText())&&" x".equals(x6.getText())  && "  ".equals(x4.getText())) 
           x4.setText(" o");
       else if(" x".equals(x4.getText())&&" x".equals(x6.getText())  && "  ".equals(x5.getText())) 
           x5.setText(" o");
       
       
       
       else if(" x".equals(x7.getText())&&" x".equals(x8.getText())  && "  ".equals(x9.getText())) 
           x9.setText(" o");
       else if(" x".equals(x8.getText())&&" x".equals(x9.getText()) && "  ".equals(x7.getText()) ) 
           x7.setText(" o");
       else if(" x".equals(x7.getText())&&" x".equals(x9.getText()) && "  ".equals(x8.getText()) ) 
           x8.setText(" o");
       
       
       
       else if(" x".equals(x1.getText())&&" x".equals(x4.getText() ) && "  ".equals(x7.getText())  ) 
           x7.setText(" o");
       else if(" x".equals(x4.getText())&&" x".equals(x7.getText())  && "  ".equals(x1.getText())) 
           x1.setText(" o");
       else if(" x".equals(x1.getText())&&" x".equals(x7.getText())&& "  ".equals(x4.getText())  ) 
           x4.setText(" o");
       
       
       
       else if(" x".equals(x2.getText())&&" x".equals(x5.getText()) && "  ".equals(x8.getText()) ) 
           x8.setText(" o");
       else if(" x".equals(x8.getText())&&" x".equals(x5.getText())  && "  ".equals(x2.getText())) 
           x2.setText(" o");
       else if(" x".equals(x2.getText())&&" x".equals(x8.getText())&& "  ".equals(x5.getText())  ) 
           x5.setText(" o");
       
       
       
       
      else if(" x".equals(x3.getText())&&" x".equals(x6.getText())&& "  ".equals(x9.getText())  ) 
           x9.setText(" o");
       else if(" x".equals(x6.getText())&&" x".equals(x9.getText()) && "  ".equals(x3.getText()) ) 
           x3.setText(" o");
       else if(" x".equals(x3.getText())&&" x".equals(x9.getText())  && "  ".equals(x6.getText())) 
           x6.setText(" o");
       
       
       
       else if(" x".equals(x1.getText())&&" x".equals(x5.getText()) && "  ".equals(x9.getText()) ) 
           x9.setText(" o");
       else if(" x".equals(x5.getText())&&" x".equals(x9.getText()) && "  ".equals(x1.getText()) ) 
           x1.setText(" o");
       else if(" x".equals(x1.getText())&&" x".equals(x9.getText()) && "  ".equals(x5.getText()) ) 
           x5.setText(" o");
       
       
       
       else if(" x".equals(x3.getText())&&" x".equals(x5.getText())&& "  ".equals(x7.getText())  ) 
           x7.setText(" o");
       else if(" x".equals(x7.getText())&&" x".equals(x5.getText())  && "  ".equals(x3.getText())) 
           x3.setText(" o");
       else if(" x".equals(x3.getText())&&" x".equals(x7.getText()) && "  ".equals(x5.getText()) ) 
           x5.setText(" o");
   ...
   public void frist_count(){
       
           if  ("  ".equals(x5.getText()))
           x5.setText(" o");
       else if ("  ".equals(x1.getText()))
           x1.setText(" o");
       else if ("  ".equals(x3.getText()))
           x3.setText(" o");
       
      
       else if ("  ".equals(x9.getText()))
           x9.setText(" o");
       else if ("  ".equals(x2.getText()))
           x2.setText(" o");
       else if ("  ".equals(x6.getText()))
           x6.setText(" o");
       else if ("  ".equals(x8.getText()))
           x8.setText(" o");
       else if ("  ".equals(x4.getText()))
           x4.setText(" o");
       else if ("  ".equals(x7.getText()))
           x7.setText(" o");
       ...
       public void case3(){   
        ...
        if (" o".equals(x5.getText()))
        {     
         if ("  ".equals(x1.getText()) &&"  ".equals(x9.getText())  )
           x1.setText(" o");   
         
         else if ("  ".equals(x1.getText()) &&" x".equals(x9.getText())  )
           x1.setText(" o");  
         else if ("  ".equals(x9.getText()) &&" x".equals(x1.getText())  )
           x9.setText(" o");
         
         
         else if ("  ".equals(x3.getText()) &&"  ".equals(x7.getText()) )
           x3.setText(" o");
         else if ("  ".equals(x3.getText()) &&" x".equals(x7.getText()) )
           x3.setText(" o");
         else if ("  ".equals(x7.getText())&&" x".equals(x3.getText()))
           x7.setText(" o");
        
         
         else if ("  ".equals(x4.getText())&&"  ".equals(x6.getText()))
             x4.setText(" o");
         
         else if ("  ".equals(x4.getText())&&" x".equals(x6.getText()))
             x4.setText(" o");
         else if (" x".equals(x4.getText())&&"  ".equals(x6.getText()))
             x6.setText(" o");
           ...
           else if (" o".equals(x7.getText()))
        {     
         if ("  ".equals(x8.getText()) &&"  ".equals(x9.getText())  )
           x8.setText(" o");  
         else if ("  ".equals(x8.getText()) &&" x".equals(x9.getText())  )
           x8.setText(" o");  
         else if (" x".equals(x8.getText()) &&"  ".equals(x9.getText())  )
           x9.setText(" o");  
         
         
         else if ("  ".equals(x5.getText()) &&"  ".equals(x3.getText()) )
             x5.setText(" o");
         else if ("  ".equals(x5.getText()) &&" x".equals(x3.getText()) )
             x5.setText(" o");
         else if (" x".equals(x5.getText()) &&"  ".equals(x3.getText()) )
             x3.setText(" o");


         else if ("  ".equals(x4.getText())&&"  ".equals(x1.getText()))
             x4.setText(" o");
         else if ("  ".equals(x4.getText())&&" x".equals(x1.getText()))
             x4.setText(" o");
         else if (" x".equals(x4.getText())&&"  ".equals(x1.getText()))
             x1.setText(" o");

        }
        
        else if (" o".equals(x1.getText()))
        {     
         if ("  ".equals(x2.getText())&&"  ".equals(x3.getText()))
           x2.setText(" o"); 
         else if ("  ".equals(x2.getText())&&" x".equals(x3.getText()))
           x2.setText(" o");   
         else if (" x".equals(x2.getText())&&"  ".equals(x3.getText()))
           x3.setText(" o");   

         
         else if ("  ".equals(x5.getText())&&"  ".equals(x9.getText()))
             x5.setText(" o");
         else if ("  ".equals(x5.getText())&&" x".equals(x9.getText()))
             x5.setText(" o");
         else if (" x".equals(x5.getText())&&"  ".equals(x9.getText()))
             x9.setText(" o");


         else if ("  ".equals(x4.getText())&&"  ".equals(x7.getText()))
             x4.setText(" o");
         else if ("  ".equals(x4.getText())&&" x".equals(x7.getText()))
             x4.setText(" o");
         else if (" x".equals(x4.getText())&&"  ".equals(x7.getText()))
             x7.setText(" o");
         
        }
        else if (" o".equals(x3.getText()))
        {     
         if ("  ".equals(x2.getText())&&"  ".equals(x1.getText()) )
           x2.setText(" o");   
         else if ("  ".equals(x2.getText())&&" x".equals(x1.getText()) )
           x2.setText(" o");   
         else  if (" x".equals(x2.getText())&&"  ".equals(x1.getText()) )
           x1.setText(" o");   

         else if ("  ".equals(x5.getText()) &&"  ".equals(x7.getText()))
             x5.setText(" o");
         else if ("  ".equals(x5.getText()) &&" x".equals(x7.getText()))
             x5.setText(" o");
         else if (" x".equals(x5.getText()) &&"  ".equals(x7.getText()))
             x7.setText(" o");


         else if ("  ".equals(x6.getText())&&"  ".equals(x9.getText()))
             x6.setText(" o");
         else if ("  ".equals(x6.getText())&&" x".equals(x9.getText()))
             x6.setText(" o");
         else if (" x".equals(x6.getText())&&"  ".equals(x9.getText()))
             x9.setText(" o");

        }
        else if (" o".equals(x9.getText()))
        {     
         if ("  ".equals(x8.getText())&&"  ".equals(x7.getText()))
           x8.setText(" o");   
         else if ("  ".equals(x8.getText())&&" x".equals(x7.getText()))
           x8.setText(" o");   
         else if (" x".equals(x8.getText())&&"  ".equals(x7.getText()))
           x7.setText(" o");   


         else if ("  ".equals(x5.getText())&&"  ".equals(x1.getText()))
             x5.setText(" o");
         else if ("  ".equals(x5.getText())&&" x".equals(x1.getText()))
             x5.setText(" o");
         else if (" x".equals(x5.getText())&&"  ".equals(x1.getText()))
             x1.setText(" o");


         else if ("  ".equals(x6.getText())&&"  ".equals(x3.getText()))
             x6.setText(" o");
         else if ("  ".equals(x6.getText())&&" x".equals(x3.getText()))
             x6.setText(" o");
         else if (" x".equals(x6.getText())&&"  ".equals(x3.getText()))
             x3.setText(" o");
         
        } 
//         else if (" o".equals(x5.getText()))
//        {     
//         if ("  ".equals(x2.getText()))
//           x2.setText(" o");   
//         else if ("  ".equals(x5.getText()))
//             x5.setText(" o");
//         else if ("  ".equals(x6.getText()))
//             x6.setText(" o");
//         
